...
This is a Copilot-primary hosted workflow. Local agents such as Claude Code can follow the same troubleshooting logic by reading `/AGENTS.md`, `/.agents/skills/troubleshoot-flux/SKILL.md`, and `/.github/agents/troubleshooter.agents.md`, but the issue-page chat and coding-agent automation described here are Copilot-specific.
